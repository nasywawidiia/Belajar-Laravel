                ...
                <a href="{{ route('user.index') }}" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M17 20h5v-2a4 4 0 00-4-4h-1m-6 6H2v-2a4 4 0 014-4h1m6 6V10m0 10a6 6 0 01-6-6V5a3 3 0 016 0v5a3 3 0 006 0V5a3 3 0 00-6 0v5m0 10a6 6 0 006-6V5a3 3 0 00-6 0v5" />
                        </svg>
                    </span>
